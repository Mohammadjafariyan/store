...
!function(t, e) {
    ...
    const I = {
        ...
        off (t, e, i, n) {
            ...
            if (void 0 === o) {
                if (h) for (const i1 of Object.keys(l))S(t, l, i1, e.slice(1));
                for (const [i2, n1] of Object.entries(c)){
                    const s1 = i2.replace(v, "");
                    a && !e.includes(s1) || L(t, l, r, n1.callable, n1.delegationSelector);
                }
            } else {
    ...
    const H = {
        ...
        getDataAttributes (t) {
            ...
            for (const n of i){
                let i1 = n.replace(/^bs/, "");
                i1 = i1.charAt(0).toLowerCase() + i1.slice(1, i1.length), e[i1] = M(t.dataset[n]);
            }
            return e;
        },
    ...
    class $ {
        ...
        _typeCheckConfig(t, e = this.constructor.DefaultType) {
            for (const [s, o] of Object.entries(e)){
                const e1 = t[s], r = n(e1) ? "element" : null == (i = e1) ? `${i}` : Object.prototype.toString.call(i).match(/\s([a-z]+)/i)[1].toLowerCase();
    ...
    const B = (t)=>{
        ...
        if (!i || "#" === i) {
            let e1 = t.getAttribute("href");
            if (!e1 || !e1.includes("#") && !e1.startsWith(".")) return null;
            e1.includes("#") && !e1.startsWith("#") && (e1 = `#${e1.split("#")[1]}`), i = e1 && "#" !== e1 ? e1.trim() : null;
        }
        return e(i);
    }, z = {
    ...
    class rt extends W {
        ...
        _addTouchEventListeners() {
            ...
            this._swipeHelper = new Y(this._element, t1);
        }
        _keydown(t) {
    ...
    class ft extends W {
        constructor(t, e){
            ...
            const i = z.find(ht);
            for (const t1 of i){
                const e1 = z.getSelectorFromElement(t1), i1 = z.find(e1).filter((t)=>t === this._element);
        ...
        show() {
            ...
            this._element.classList.remove(lt), this._element.classList.add(ct), this._element.style[e1] = 0, this._addAriaAndCollapsedClass(this._triggerArray, !0), this._isTransitioning = !0;
            const i = `scroll${e1[0].toUpperCase() + e1.slice(1)}`;
            this._queueCallback(()=>{
                this._isTransitioning = !1, this._element.classList.remove(ct), this._element.classList.add(lt, at), this._element.style[e1] = "", I.trigger(this._element, "shown.bs.collapse");
        ...
        hide() {
            ...
            for (const t1 of this._triggerArray){
                const e = z.getElementFromSelector(t1);
        ...
        _initializeChildren() {
            ...
            for (const e of t){
                const t1 = z.getElementFromSelector(e);
    ...
    I.on(document, "click.bs.collapse.data-api", ht, function(t) {
        ...
        for (const t1 of z.getMultipleElementsFromSelector(this))ft.getOrCreateInstance(t1, {
            toggle: !1
        }).toggle();
    }), f(ft);
    ...
    class ci extends W {
        ...
        show() {
            ...
            if (!I.trigger(this._element, "show.bs.dropdown", t).defaultPrevented) {
                if (this._createPopper(), "ontouchstart" in document.documentElement && !this._parent.closest(".navbar-nav")) for (const t1 of [].concat(...document.body.children))I.on(t1, "mouseover", l);
        ...
        _completeHide(t) {
            if (!I.trigger(this._element, "hide.bs.dropdown", t).defaultPrevented) {
                if ("ontouchstart" in document.documentElement) for (const t1 of [].concat(...document.body.children))I.off(t1, "mouseover", l);
        ...
        static clearMenus(t) {
            ...
            const e = z.find(Ze);
            for (const i of e){
                const e1 = ci.getInstance(i);
                if (!e1 || !1 === e1._config.autoClose) continue;
                const n = t.composedPath(), s = n.includes(e1._menu);
                if (n.includes(e1._element) || "inside" === e1._config.autoClose && !s || "outside" === e1._config.autoClose && s) continue;
    ...
    class Ii extends W {
        ...
        _adjustDialog() {
            ...
            if (i && !t) {
                const t1 = u() ? "paddingLeft" : "paddingRight";
                this._element.style[t1] = `${e}px`;
            }
            if (!i && t) {
                const t2 = u() ? "paddingRight" : "paddingLeft";
        ...
        _maybeSanitize(t) {
            return this._config.sanitize ? function(t, e, i) {
                ...
                for (const t1 of s){
                    ...
                    const n1 = [].concat(...t1.attributes), s1 = [].concat(e["*"] || [], e[i1] || []);
                    for (const e1 of n1)Vi(e1, s1) || t1.removeAttribute(e1.nodeName);
                }
    ...
    class ln extends W {
        ...
        show() {
            ...
            if (this._element.ownerDocument.documentElement.contains(this.tip) || (n.append(i), I.trigger(this._element, this.constructor.eventName("inserted"))), this._popper = this._createPopper(i), i.classList.add(Zi), "ontouchstart" in document.documentElement) for (const t1 of [].concat(...document.body.children))I.on(t1, "mouseover", l);
            this._queueCallback(()=>{
        ...
        _setListeners() {
            ...
            for (const e of t)if ("click" === e) I.on(this._element, this.constructor.eventName("click"), this._config.selector, (t)=>{
                ...
                const t1 = e === nn ? this.constructor.eventName("mouseenter") : this.constructor.eventName("focusin"), i = e === nn ? this.constructor.eventName("mouseleave") : this.constructor.eventName("focusout");
                I.on(this._element, t1, this._config.selector, (t)=>{
        ...
        _getConfig(t) {
            ...
            for (const t1 of Object.keys(e))Gi.has(t1) && delete e[t1];
            return t = {
                ...e,
                ..."object" == typeof t && t ? t : {}
    ...
    class _n extends W {
        ...
        _initializeTargetsAndObservables() {
            ...
            for (const e of t){
                ...
                const t1 = z.findOne(e.hash, this._element);
                o(t1) && (this._targetLinks.set(e.hash, e), this._observableSections.set(e.hash, t1));
            }
        }
        _process(t) {
        ...
        _activateParents(t) {
            ...
            else for (const e of z.parents(t, ".nav, .list-group"))for (const t1 of z.prev(e, ".nav-link, .nav-item > .nav-link, .list-group-item"))t1.classList.add(fn);
        }
        _clearActiveClass(t) {
            t.classList.remove(fn);
            const e = z.find("[href].active", t);
            for (const t1 of e)t1.classList.remove(fn);
        }
        static jQueryInterface(t) {
            return this.each(function() {
