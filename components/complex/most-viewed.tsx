    ...
    render() {
            ...
            return (
                <div className="product-item" >
                    <div className="product-item-content">
                        <div className="mb-3">
                            <SkeletonLazyImage width={150} height={150} src={`${product.src}`} onError={(e:any) => e.target.src = 'https://www.primefaces.org/wp-content/uploads/2020/05/placeholder.png'} alt={product.alt} className="product-image small-resp-image image-responsive" />
                        </div>
                        <div>
        ...
        return (
            <div dir='ltr'>
                ...
                <h5 className='text-center mt-3'>محصولات با بیشترین بازدید</h5>
                <br/>
